...
<body>
    ...
    <main>
        <section id="home">
            ...
            <?php
            echo "<p>Halo Dunia</p>";
            echo "<p>Nama saya Satria Akbar</p>";
            ?>
        </section>

        <section id="about">
            <h2>About Satria Akbar &#128516;</h2>
            <?php
            $NIM            = "2511500043";
            $Nama_Lengkap   = "Satria Akbar";
            $Tempat_Lahir   = "Batam";
            $Tanggal_Lahir  = "25 Juni 2005";
            $Pekerjaan      = "Mahasiswa";
            $Pasangan       = "Belum Punya";
            $Nama_Ayah      = "Tatang Suparta";
            $Nama_Ibu       = "Liza Desraini";
            $Nama_Kakak     = "Putri Zeta Nofarrani";
            $Nama_Adik      = "Sakti Fatrian";
